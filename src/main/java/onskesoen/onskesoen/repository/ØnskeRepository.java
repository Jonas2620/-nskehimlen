...
public class ØnskeRepository {
    ...
    public void opdaterØnske(Ønske ønske) {
        String sql = "UPDATE ønske SET ønske_navn = ? WHERE ønske_id = ?";
